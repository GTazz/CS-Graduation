...
public class App {
    public static String _repeat(String str, int times) {
    ...
    public static void atividade1() {
        ...
        // Imprime uma nova linha ao final para garantir que o cursor fique na linha
        // seguinte
        System.out.println("\n");
    }
    ...
    public static void atividade2b() {
        ...
        String characters = _repeat("  ", num - 1) + _repeat("* ", num);
        
        System.out.println("");
        for (int i = 0; i < num * 2; i = i + 2) {
            System.out.print(characters.substring(i, num * 2 - 2));
            System.out.println(characters.substring(num * 2 - 2, num * 2 + i));
        }
    ...
    // ================ ATIVIDADE 2C ================
    public static void atividade2c() {
        int num;
        ...
        // Fiz assim só pra confundir mesmo kkkkkkkk
        System.out.print(_repeat("\n" + _repeat("* ", num), num) + "\n\n");
    }
